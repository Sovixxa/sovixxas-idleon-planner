...
for(const group of ['Tunnels','Discoveries','Upgrades','Daily Lore'])assert(g.spelunking.some(x=>x.group===group),group);
assert(g.spelunking.find(x=>x.group==='Tunnels').icon.includes('CaveDoor'));
