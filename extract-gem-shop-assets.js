...
try{
 ...
 const offset=8+pre.readUInt32LE(4)+Number(entry.offset),wanted=/^(?:Gem[QP]\d+|InvBag21|InvStorage31|InvStorage99|Pdaily[01]|ClassSwapC|PremiumGem)\.png$/;
 ...
 console.log('Extracted',names.length,'Gem Shop sprites.');
