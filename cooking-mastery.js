...
const api={defaultWeight,cookingOnly,multi,relative,speedAt,yellowRows,purpleRows,allocate,bonusAt,accountSetup,yumiAllocation,gainSummary,preview,render};if(typeof module!=='undefined'&&module.exports)module.exports=api;else root.CookingMastery=api;
