...
add('Equipment, Gallery & Hat Rack|BONUS DROP RATE equipment pool|DROP RATE MULTI equipment pool','nametags','Gallery','Combines equipment, Gallery and Hat Rack bonuses for this stat label. Each pool is applied separately by the game.','Setup-dependent: item rolls, equipped slots, collection progress and amplification all matter. There is no single gear-pool cap.');
