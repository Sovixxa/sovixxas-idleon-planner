(()=>{
  ...
  const SKILL_PAGES={
    ...
    construction:{title:'Construction',world:'World 3',copy:'Construction buildings, cogs, and build priorities will be planned here.',tabs:['shrines']},refinery:{title:'Refinery',world:'World 3',copy:'Refinery salts and production priorities.'},printer:{title:'3D Printer',world:'World 3',copy:'3D Printer samples, slots, and output.'},worship:{title:'Worship',world:'World 3',copy:'Worship waves and account bonuses.'},prayers:{title:'Prayers',world:'World 3',copy:'Prayer loadouts, benefits, and tradeoffs.'},saltLick:{title:'Salt Lick',world:'World 3',copy:'Salt Lick levels and permanent account bonuses.'},shrines:{title:'Shrines',world:'World 3',copy:'Shrine levels, placement, and active bonuses.',parent:'construction'},deathNote:{title:'Death Note',world:'World 3',copy:'Monster kills, skull ranks, and multikill progression.'},atomCollider:{title:'Atom Collider',world:'World 3',copy:'Atom upgrade levels and permanent effects.'},armorSets:{title:'Armor Sets',world:'World 3',copy:'Armor Smithy sets and their permanent account bonuses.'},trapping:{title:'Trapping',world:'World 3',copy:'Trapping critters, traps, and collection timing will be modeled here.'},towerDefense:{title:'Tower Defense',world:'World 3',copy:'Worship tower-defense setups, waves, and soul rewards will be modeled here.',parent:'worship'},equinox:{title:'Equinox',world:'World 3',copy:'Equinox challenges and permanent account bonus planning will be modeled here.'},
    lab:{title:'Lab',world:'World 4',copy:'Lab chip, jewel, and connection planning will be modeled here.'},breeding:{title:'Breeding',world:'World 4',copy:'Breeding pets, spices, and arena planning will be modeled here.',tabs:['petArena','shinyPets']},shinyPets:{title:'Shiny Pets',world:'World 4',copy:'Account-wide bonuses from combined shiny pet levels.',parent:'breeding'},cooking:{title:'Cooking',world:'World 4',copy:'Cooking meals, kitchens, and recipe priorities will be modeled here.'},petArena:{title:'Pet Arena',world:'World 4',copy:'Pet Arena teams, bonuses, and reward planning will be modeled here.',parent:'breeding'},rift:{title:'Rift',world:'World 4',copy:'Rift progression, rewards, and challenge planning will be modeled here.'},tome:{title:'Tome',world:'World 4',copy:'Tome rankings, completion score, and account bonuses.'},
    divinity:{title:'Divinity',world:'World 5',copy:'Divinity gods, links, and style planning will be modeled here.'},sailing:{title:'Sailing',world:'World 5',copy:'Sailing boats, artifacts, and island routes will be modeled here.'},gaming:{title:'Gaming',world:'World 5',copy:'Gaming plants and upgrade planning will be modeled here.'},gamingPalette:{title:'Gaming Palette',world:'World 5',copy:'Gaming palette levels and their account-wide bonuses.'},upgradeVault:{title:'Upgrade Vault',world:'World 5',copy:'Upgrade Vault levels and permanent bonuses.'},hole:{title:'The Hole',world:'World 5',copy:'The Hole progression and every decoded cavern mechanic.',tabs:['holeSchematics','holeMajik','holeStudies','holeMeasurements','holeMonuments','holeBell','holeWell','holeFountain','holeResources','holeHarp','holeLamp','holeDawgDen','holeJars','holeGambit']},holeSchematics:{title:'Schematics',world:'World 5',copy:'Engineer schematics and their permanent effects.',parent:'hole'},holeMajik:{title:'Majik',world:'World 5',copy:'Conjuror Majik upgrades.',parent:'hole'},holeStudies:{title:'Studies',world:'World 5',copy:'Librarian study levels and bonuses.',parent:'hole'},holeMeasurements:{title:'Measurements',world:'World 5',copy:'Measurer bonuses and account scaling.',parent:'hole'},holeMonuments:{title:'Monuments',world:'World 5',copy:'Bravery, Justice, and Wisdom bonuses.',parent:'hole'},holeBell:{title:'Bell',world:'World 5',copy:'Bell improvements and permanent bonuses.',parent:'hole'},holeWell:{title:'Well',world:'World 5',copy:'Sediment bars, expansions, and buckets.',parent:'hole'},holeFountain:{title:'Fountain',world:'World 5',copy:'Fountain upgrade levels and bonuses.',parent:'hole'},holeResources:{title:'Resource Caverns',world:'World 5',copy:'Motherload, Hive, and Evertree layers.',parent:'hole'},holeHarp:{title:'Harp',world:'World 5',copy:'Harp strings, levels, and note resources.',parent:'hole'},holeLamp:{title:'Lamp',world:'World 5',copy:'Lamp wishes and completed wish counts.',parent:'hole'},holeDawgDen:{title:'Dawg Den',world:'World 5',copy:'Dawg Den score progression.',parent:'hole'},holeJars:{title:'Jars',world:'World 5',copy:'Jar types and permanent bonuses when present in the save.',parent:'hole'},holeGambit:{title:'Gambit',world:'World 5',copy:'Gambit challenges, scores, and rewards.',parent:'hole'},slab:{title:'Slab',world:'World 5',copy:'Slab collection progress and every account bonus.'},
    ...
    minehead:{title:'Minehead',world:'World 7',copy:'Minehead production and progression planning will be modeled here.'},spelunking:{title:'Spelunking',world:'World 7',copy:'Spelunking upgrades and route planning will be modeled here.'},research:{title:'Research',world:'World 7',copy:'Research nodes, observation layouts, and account bonus priorities will be modeled here.'},sushi:{title:'Sushi',world:'World 7',copy:'Unique Sushi unlocks and permanent effects.'},button:{title:'The Button',world:'World 7',copy:'Button press categories and their account bonuses.'},coral:{title:'Coral',world:'World 7',copy:'Coral collection and upgrade planning will be modeled here.'},clamworks:{title:'Clamworks',world:'World 7',copy:'Clam work levels, promotions, and pearl bonuses.'},meritocracy:{title:'Meritocracy',world:'World 7',copy:'World 7 ballot bonuses and current selection.'},bigFish:{title:'Big Fish',world:'World 7',copy:'Big Fish advice levels and permanent bonuses.'},coralKid:{title:'Coral Kid',world:'World 7',copy:'Coral Kid upgrade levels and account bonuses.'},coralReef:{title:'Coral Reef',world:'World 7',copy:'Daily coral progression and reef upgrades.'},dancingCoral:{title:'Dancing Coral',world:'World 7',copy:'Purchased coral dances and permanent bonuses.'},hoops:{title:'Hoops',world:'World 7',copy:'Hoops scores, levels, and permanent bonuses.'},darts:{title:'Darts',world:'World 7',copy:'Darts scores, levels, and permanent bonuses.'},zenithMarket:{title:'Zenith Market',world:'World 7',copy:'Zenith Cluster upgrades and permanent bonuses.'},nametags:{title:'Nametags & Trophies',world:'World 7',copy:'Nametag and Trophy Gallery progress will be modeled here.'},legendTalents:{title:'Legend Talents',world:'World 7',copy:'Account-wide Legend Talent levels and bonuses.'},
  ...
  function activityFor(target){
    ...
    if(/farm|crop|garden/.test(raw))return {label:'Farming',icon:'🌱'};
    if(/spelunk/.test(raw))return {label:'AFK spelunking',icon:'⛏'};
    if(!raw||raw==='none')return {label:'AFK / no target',icon:'💤'};
    return {label:'Killing',icon:'⚔'};
  }
  function characterRows(){
    const data=state?.rawData||{},names=Array.isArray(state?.rawRoot?.charNames)?state.rawRoot.charNames:[];const ids=Object.keys(data).map(k=>{const m=k.match(/^AFKtarget_(\d+)$/);return m?Number(m[1]):null;}).filter(x=>x!=null).sort((a,b)=>a-b);
    return ids.map(id=>{let stuff=data['PlayerStuff_'+id];if(typeof stuff==='string'){try{stuff=JSON.parse(stuff);}catch(_){stuff=[];}}if(!Array.isArray(stuff))stuff=[];const lv=data['Lv0_'+id],level=Array.isArray(lv)?Math.round(Number(lv[0])||0):null;
      const rawTarget=data['AFKtarget_'+id],activity=activityFor(rawTarget);return {id,name:names[id]||`Character ${id+1}`,target:humanTarget(rawTarget),afk:afkDuration(stuff[0]),level,classId:data['CharacterClass_'+id],classIcon:classIcon(data['CharacterClass_'+id]),activity};
    });
  }
  function renderHome(){
    const rows=characterRows();
    $('characterDashboard').innerHTML=rows.map(row=>`<article class="character-card"><div class="character-avatar" title="Class ${esc(row.classId??'—')}">${row.classIcon}</div><div class="character-main"><h3>${esc(row.name)}</h3><p>Level ${row.level??'—'} · ${esc(row.target)}</p><strong><span class="activity-icon">${row.activity.icon}</span>${esc(row.activity.label)}</strong></div><div class="character-afk"><span>AFK time</span><strong>${esc(row.afk)}</strong></div></article>`).join('')||'<p class="subtitle">This export does not include character activity. Load a full IdleOn save to populate Home.</p>';
  }
  ...
  function renderArcade(){
    ...
    const arcadeBonus=(item,level)=>{if(level==null)return null;const value=item.formula==='add'?item.base*level:item.formula==='decay'?item.base*level/(level+item.scale):item.formula==='intervalAdd'?item.base+Math.floor(level/item.scale):null;return value==null?null:value*(level===101?2:1);};
    const bonusLabel=(item,level)=>{const value=arcadeBonus(item,level);return value==null?'Bonus unknown':'+'+value.toLocaleString(undefined,{maximumFractionDigits:2})+(item.description.includes('{%')?'%':'');};
    ...
    const show=id=>{selectedArcade=id;const item=catalog.find(x=>x.id===id);if(!item)return;const level=levelOf(id);const bonus=arcadeBonus(item,level);
      ...
      $('arcadeDetail').innerHTML=`<button type="button" class="secondary upgrade-close" id="arcadeDetailClose" aria-label="Close arcade details">Close</button><p class="eyebrow">Arcade upgrade ${id+1}</p><h3>${esc(titleOf(item))}</h3><p><strong>${level==null?'Saved level unavailable':`Current level: ${Math.min(level,100)}${level===101?' · Cosmo-balled (saved as 101)':' · Not Cosmo-balled'}`}</strong></p><p class="exp-benefit">${bonus==null?'Bonus calculation unavailable':esc(item.description.replace('{',bonus.toLocaleString(undefined,{maximumFractionDigits:3})))}</p><p>${bonus==null?'Load a complete save to inspect this upgrade.':'Calculated from the installed client formula, including level-101 doubling. Companion 27’s additional doubling is not included.'}</p><details><summary>Formula and breakpoint</summary><p>${item.formula==='decay'?`${item.base} × level / (level + ${item.scale})`:item.formula==='add'?`${item.base} × level`:item.formula==='intervalAdd'?`${item.base} + floor(level / ${item.scale})`:'Formula not yet supported'}. At exactly level 101, the client doubles the result.</p></details>`;
    };
  ...
  function renderStamps(){
    ...
    const count=catalog.reduce((n,g,gi)=>n+g.stamps.filter((_,i)=>levelOf(gi,i)>0).length,0),total=catalog.reduce((n,g)=>n+g.stamps.length,0);
    $('worldContent').innerHTML=`<div class="section-head compact"><div><p class="eyebrow">World 1 · account-wide</p><h2>Stamps</h2><p>Hover a stamp for its level and effect, or select it to keep the details open.</p></div><strong class="stamp-count">${count} / ${total} leveled</strong></div><div class="stamp-workspace"><div class="stamp-catalog">${catalog.map((group,gi)=>`<section class="stamp-group"><h3>${esc(group.name)}</h3><div class="stamp-grid">${group.stamps.map((stamp,i)=>{const level=levelOf(gi,i);return `<button type="button" class="stamp-tile stamp-select ${level===0?'locked':''}" data-stamp-group="${gi}" data-stamp-index="${i}" aria-pressed="false" aria-label="${esc(stamp.name)}. ${level==null?'Level unavailable':`Level ${level}`}."><div class="stamp-art">${stamp.image?`<img src="${esc(stamp.image)}" alt="" loading="lazy">`:`<span class="stamp-fallback">${esc(stamp.id)}</span>`}</div><span class="stamp-level">${level==null?'Unknown':level===0?'Lv 0':`Lv ${level.toLocaleString()}`}</span><div class="stamp-tip"><strong>${esc(stamp.name)}</strong><span class="stamp-tip-level">${level==null?'Saved level unavailable':`Lv ${level.toLocaleString()}`}</span><b>${esc(stamp.bonus)}</b></div></button>`;}).join('')}</div></section>`).join('')}<section id="stampDetail" class="exp-card" aria-live="polite"></section></div>`;
    const show=(g,i)=>{selectedStamp=[g,i];const stamp=catalog[g]?.stamps[i];if(!stamp)return;const level=levelOf(g,i);$('worldContent').querySelectorAll('[data-stamp-group]').forEach(tile=>{const active=Number(tile.dataset.stampGroup)===g&&Number(tile.dataset.stampIndex)===i;tile.classList.toggle('selected',active);tile.setAttribute('aria-pressed',String(active));});$('stampDetail').innerHTML=`<button type="button" id="stampDetailClose" class="stamp-detail-close secondary" aria-label="Close stamp details">Close</button><p class="eyebrow">${esc(catalog[g].name)} · Stamp ${i+1}</p><h3>${esc(stamp.name)}</h3><p><strong>${level==null?'Saved level unavailable':`Current level: ${level.toLocaleString()}`}</strong></p><p class="exp-benefit">${esc(stamp.bonus)}</p>${g===0&&i===43&&level!=null?`<p>Base bonus: +${window.ClassExp.stamp(level).toLocaleString(undefined,{maximumFractionDigits:3})}% Class EXP, before stamp amplifiers.</p>`:'<p class="muted">Effect shown above. The numeric bonus and stamp amplifiers have not been calculated yet.</p>'}${level===0?'<p>No saved levels. Acquisition and hand-in status are not separately decoded.</p>':''}</section>`;$('stampDetailClose').onclick=()=>$('stampDetail').classList.add('stamp-detail-dismissed');};
  ...
  function renderClassExp(){
    ...
    tabs.innerHTML=[["optimizer","Optimizer"],["sources","EXP Sources"],["gear","Gear Setups"]].map(([id,label])=>`<button role="tab" aria-selected="${expTab===id}" class="skill-tab ${expTab===id?"active":""}" data-exp-tab="${id}">${label}</button>`).join("");
  ...
  function renderWorldPage(name){
    ...
    const addSubtabs=()=>{const parentKey=page.parent||name,parent=SKILL_PAGES[parentKey],keys=[parentKey,...(parent.tabs||[])];if(keys.length<2)return;const nav=document.createElement('nav');nav.className='skill-tabs';nav.setAttribute('role','tablist');nav.setAttribute('aria-label',`${parent.title} sections`);nav.innerHTML=keys.map(key=>`<button class="skill-tab${key===name?' active':''}" data-skill-tab="${esc(key)}" role="tab" aria-selected="${key===name}">${esc(SKILL_PAGES[key].title)}</button>`).join('');const head=$('worldContent').querySelector('.section-head,.bonus-system-hero');head?.insertAdjacentElement('afterend',nav);nav.querySelectorAll('[data-skill-tab]').forEach(button=>button.onclick=()=>selectSideNav(button.dataset.skillTab));};
    ...
    if(['statues','dungeons','obols','refinery','printer','prayers','hole'].includes(name)){window.RemainingWorlds.render($('worldContent'),name,state?.rawData||{},state?.rawRoot||{});addSubtabs();return;}
    if(name==='construction'){renderConstruction();addSubtabs();return;}
    if(name==='worship'){window.Worship.render($('worldContent'),state?.rawData||{});return;}
    if(name==='armorSets'){window.ArmorSets.render($('worldContent'),state?.rawData||{});return;}
    if(['vials','sigils','votes','killroy','saltLick','shinyPets','upgradeVault','gamingPalette','emperorBonuses','compass','grimoire','tesseract','orion','poppy','bubba','starSigns','constellations','shrines','deathNote','forgeBonuses','anvilUpgrades','islandExpeditions','poExtras','atomCollider','eventShop','familyBonuses','gemShop','friendBonuses','holeSchematics','holeMajik','holeStudies','holeMeasurements','holeMonuments','holeBell','holeWell','holeFountain','holeResources','holeHarp','holeLamp','holeDawgDen','holeJars','holeGambit','clamworks','meritocracy','bigFish','coralKid','coralReef','dancingCoral','hoops','darts','zenithMarket','sushi','button','legendTalents'].includes(name)){window.BonusSystems.render($('worldContent'),name,loadedExport||state?.rawRoot||{});addSubtabs();return;}
    ...
    if(name==='divinity'){window.Divinity.render($('worldContent'),state?.rawData||{},state?.rawRoot||{});return;}
    if(name==='sailing'||name==='gaming'){window.World5.render($('worldContent'),name,state?.rawData||{});return;}
    if(name==='tome'||name==='slab'){window.Collections.render($('worldContent'),name,state?.rawData||{});return;}
    ...
    if(name==='buffs'){window.MiscBuffs.render($('worldContent'),state?.rawData||{},state?.rawRoot||{});return;}
    ...
    if(name==='credits'){
      ...
      const sheets=[['Antho & Arkh’s IdleOn Spreadsheet','World-grouped statue farming, active locations, statue value, and statue drop multipliers.','https://docs.google.com/spreadsheets/d/1IcxwlHKPcw57PJxOWmtCJTP2Iv6ubdRSEwzMjbH476U/edit?gid=510141304#gid=510141304'],['IdleOn Community Spreadsheet 2','Community planning and game-reference spreadsheet supplied by the project owner.','https://docs.google.com/spreadsheets/d/1at-y9t5ohYky33nOLoSxHYeyRX-3T91paj-nTSHrB3c/edit?gid=1149427600#gid=1149427600'],['IdleOn Community Spreadsheet 3','Community planning and game-reference spreadsheet supplied by the project owner.','https://docs.google.com/spreadsheets/d/1z1P2ouvYhe2pryWoF0kIQE7QichYpJt1GaPPos-e-aw/htmlview?ouid=100192538871121683136&usp=sheets_home&ths=true&pru=AAABnvRY65A*74Ik4AaZgon0T7BqbOmu6w#']];
      $('worldContent').innerHTML=`<div class="section-head compact"><div><p class="eyebrow">About this planner</p><h2>Credits &amp; Resources</h2><p>Helpful work from the IdleOn community that informed parts of this planner.</p></div></div><nav class="skill-tabs credits-tabs"><button class="skill-tab active" data-credit-tab="resources">Credits &amp; Resources</button><button class="skill-tab" data-credit-tab="sheets">Spreadsheets</button></nav><div id="creditResources"><section class="credits-note"><strong>Thank you to the guide makers, wiki editors, researchers, and players who share their findings.</strong><span>This planner uses its own presentation and calculations. External strategies are credited here so users can visit the original sources.</span></section><div class="credits-grid">${resources.map(([title,description,url])=>`<a href="${url}" target="_blank" rel="noopener noreferrer"><span>External resource</span><strong>${esc(title)}</strong><p>${esc(description)}</p><b>Visit source →</b></a>`).join('')}</div></div><div id="creditSheets" class="hidden"><section class="credits-note"><strong>Community spreadsheets</strong><span>Original planning sheets and calculators used as references, preserved with direct links to their source.</span></section><div class="credits-grid spreadsheet-grid">${sheets.map(([title,description,url],i)=>`<a href="${url}" target="_blank" rel="noopener noreferrer"><span>Community spreadsheet ${i+1}</span><strong>${esc(title)}</strong><p>${esc(description)}</p><b>Open spreadsheet →</b></a>`).join('')}</div></div><p class="credits-disclaimer">Legends of Idleon and its assets belong to LavaFlame2. This is an independent local planning tool and is not affiliated with or endorsed by the game or the linked guide authors.</p>`;
      $('worldContent').querySelectorAll('[data-credit-tab]').forEach(button=>button.onclick=()=>{const sheets=button.dataset.creditTab==='sheets';$('creditResources').classList.toggle('hidden',sheets);$('creditSheets').classList.toggle('hidden',!sheets);$('worldContent').querySelectorAll('[data-credit-tab]').forEach(x=>x.classList.toggle('active',x===button));});
      return;
    }
