...
const num=(v,d=2)=>!Number.isFinite(v)?'Unavailable':Math.abs(v)>=1e12?v.toExponential(4):v.toLocaleString('en-US',{maximumFractionDigits:d});
...
root.CombatStatTabs={render,characterHtml,missingHtml};
